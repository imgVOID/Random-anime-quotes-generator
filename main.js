$(document).ready(function() {
  ...
  function blink() {
    $('#twitter').toggleClass('animated pulse');
  };
  setInterval(blink, 1500);
  
  $(".quote-masta").on("click", function() {
    $('.leftCol').removeClass('animated zoomInRight');
    
    $('.leftCol').addClass('animated hinge');
    function goOut(){
      $('.leftCol').removeClass('animated hinge');
      random_generate();
      $('.leftCol').addClass('animated zoomInRight');
  ...
  function random_generate() {
    ...
    anime_quote[1] = {
      "quotenumber": 2,
      "quotesentence": "`There's no short-cut to becoming strong. Even if you try to look strong on the outside, that thin layer will soon fall off.",
      "quotecharacter": "- Shimura Shinpachi",
      "quoteanime": " Gintama"
    }
    ...
    anime_quote[17] = {
      "quotenumber": 18,
      "quotesentence": "A temporary defeat is nothing if it leads to ultimate victory!",
      "quotecharacter": "- Stephanie Dola,",
    ...
    anime_quote[33] = {
      "quotenumber": 34,
      "quotesentence": "Who'd eat a pervert's banana?",
      "quotecharacter": "- Kurisu Makise,",
      "quoteanime": " Steins;Gate"
    }
    
    anime_quote[34] = {
      "quotenumber": 35,
      "quotesentence": "Destiny. Fate. Dreams. These unstoppable ideas are held deep in the heart of man. As long as there people who seek freedom in this life, These things shall not vanish from the Earth.",
      "quotecharacter": "- Gol D. Roger",
   ...
   anime_quote[70] = {
    ...
    anime_quote[78] = {
      "quotenumber": 79,
      "quotesentence": "I'm sure that things that are truly fun can't be compared. Back then, now, and from now on, in the time you spend with others, lots of small fun things are born and disappear.",
    ...
    anime_quote[82] = {
      "quotenumber": 83,
      "quotesentence": "Even in the depths of the darkest oceans, some light always pierces through.",
      "quotecharacter": "Arima Kousei",
      "quoteanime": "Your Lie in April"
    }
    
    anime_quote[83] = {
      "quotenumber": 84,
      "quotesentence": "No matter how severe the situation is, if you continue to stay there, you'll accept everything as a everyday life.",
      "quotecharacter": "Psycho-Pass",
      "quoteanime": "Your Lie in April",
    }
  ...
  // sentence for twitter //
    
    anime_quote2 = anime_quote[random_number].quotesentence + " " + anime_quote[random_number].quotecharacter + anime_quote[random_number].quoteanime;
  ...
  $("#twitter").on("click", function(e) {
    var textToTweet = anime_quote2;
    if (textToTweet.length > 1) {
